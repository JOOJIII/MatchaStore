        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="bg-white text-matcha-green px-4 py-2 rounded-lg font-semibold hover:bg-gray-100">Login</a>
                        <a href="{{ route('register') }}" class="bg-green-300 text-matcha-green px-4 py-2 rounded-lg font-semibold hover:bg-green-400">Register</a>
                    @endauth
                </div>
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    @auth
                        <a href="{{ route('cart.index') }}" class="hover:text-green-300 transition">Cart</a>
                            <a href="{{ route('wishlist.index') }}" class="relative hover:text-green-300 mr-4">
                                <i class="fas fa-heart text-xl"></i>
                                @if(auth()->user()->wishlists()->count() > 0)
                                    <span class="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center wishlist-count">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-300">Premium matcha products delivered to your door. Experience the authentic taste of Japanese matcha.</p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('feedback.create') }}" class="text-gray-300 hover:text-white">Feedback</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-300 hover:text-white">Matcha Powder</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white">Matcha Tea</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white">Matcha Desserts</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-center space-x-2">
                            ...
                            <span class="text-gray-300">Tokyo, Japan</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <i class="fas fa-phone text-green-300"></i>
                            <span class="text-gray-300">+81 123-456-789</span>
                        </li>
                        <li class="flex items-center space-x-2">

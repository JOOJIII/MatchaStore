...
@section('title', 'Register - Matcha Store')
...
<div class="container mx-auto px-4 py-16">
    <div class="max-w-md mx-auto">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Join Matcha Store for the best matcha experience</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" class="w-full border rounded-lg px-4 py-3 focus:outline-none focus:border-matcha-green" required autofocus>
                    @error('name')
                ...
                <div class="mb-6">
                    ...
                    <input type="email" name="email" class="w-full border rounded-lg px-4 py-3 focus:outline-none focus:border-matcha-green" required>
                    @error('email')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-600">Already have an account? 
                        <a href="{{ route('login') }}" class="text-matcha-green font-semibold hover:underline">Sign in</a>
                    </p>
                </div>
            </form>
        </div>
